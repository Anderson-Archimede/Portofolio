...
function ThemeToggle({
  ...
  return (
    <motion.button
      ...
      aria-label={
        isDark
          ? lang === "fr" ? "Passer en mode noir" : "Switch to black mode"
          : lang === "fr" ? "Passer en mode zinc" : "Switch to zinc mode"
      }
      aria-pressed={!isDark}
    >
      <motion.span
      ...
      >
        {isDark ? (
          /* Moon icon — shown in default zinc mode to switch to near-black */
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
          </svg>
        ) : (
          /* Sun icon — shown in near-black mode to switch back to zinc */
...
function LangToggle({
  ...
  // Default (zinc, theme="dark"): zinc-700 container on zinc-800 card.
  // Toggle (near-black, theme="light"): near-black container on #101010 card.
  const containerBg = theme === "light" ? "#1e1e20" : "#3f3f46";
  const containerBorder = theme === "light" ? "1px solid #2e2e32" : "1px solid #52525b";

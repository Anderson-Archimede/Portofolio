      ...
      jobs: [
        {
          ...
          role: "Business Analyst / Consultant BI",
          ...
          highlights: [
            "Analyse des besoins métiers auprès des directions Assurance, RH et Commerce",
            "Animation d'ateliers métiers pour le cadrage fonctionnel des projets",
        ...
        },
        {
          ...
          description: "Avec plus de 3 ans d'expérience (Finance, Assurance, Mobilité), je ne me contente pas de créer de beaux tableaux de bord. Je conçois des écosystèmes analytiques complets orientés ROI.",
          highlights: [
        ...
        },
        {
          ...
          role: "Ingénieur Support Data & Assistant Product Owner",
